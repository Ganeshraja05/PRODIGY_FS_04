...
// Generate random text for the futuristic container
const futuristicText = document.getElementById('futuristic-text');
...
setInterval(() => {
  ...
  futuristicText.textContent = randomTexts[randomIndex];
}, 3000);